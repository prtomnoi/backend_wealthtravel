                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item border-0 px-0">
                                <div class="form-group form-switch ps-0">
                                    ...
                                    <div class="previewPdf" id="previewPdf">
                                        @if (@$main->AttachFilePdf)
                                            <a href="{{ route('tour.pdf', @$main->id) }}" target="_blank" rel="noopener noreferrer">
                                                <svg version="1.1" id="_x34_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                                viewBox="0 0 512 512"  xml:space="preserve" style="max-width: 100px;">
                                           <g>
