...
@section('pages')
    <li class="breadcrumb-item text-sm text-dark"><a href="{{ route('reviews.index') }}">Reviews</a></li>
@endsection
                ...
                <div class="card-body px-0 pb-2">
                    <div class="table-responsive">
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Reviews</th>
    ...
    function deleteItem(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var is_url = "{{ route('reviews.destroy', ':id') }}";
                    $.ajax({
