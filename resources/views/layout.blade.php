...
<head>
    ...
    <title>
        @yield('title', 'home') | Wealth inter travel
    </title>
    <!--     Fonts and icons     -->
    ...
    <link rel="stylesheet" href="{{ asset('assets/libs/fontawesome-free-6.6.0-web/css/all.min.css') }}">
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('tourType.index') }}" id="tourType">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">Tour Type</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  " href="{{ route('tour.index') }}" id="tour">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('serviceType.index') }}" id="serviceType">
                        ...
                        <span class="nav-link-text ms-1">Service Type</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('service.index') }}" id="service">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        @yield('pages')
                        {{-- <li class="breadcrumb-item text-sm text-dark">@yield('pages', 'Dashboard')</li> --}}
                        {{-- <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Dashboard2</li> --}}
                    </ol>
                    <h6 class="font-weight-bolder mb-0">@yield('pages-title', 'Dashboard')</h6>
                </nav>
