...
@section('pages')
    <li class="breadcrumb-item text-sm text-dark"><a href="{{ route('tourType.index') }}">Tour Types</a></li>
@endsection

@section('pages-title', 'Tour Type')
                ...
                <div class="card-body px-0 pb-2">
                    <div class="table-responsive">
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tour Type</th>
                            ...
                            <tbody>
                                @forelse (@$data as $key => $item)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="d-flex px-2 py-1">
                                                <a href="{{ route('tourType.edit', @$item->id) }}"
    ...
    function deleteItem(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var is_url = "{{ route('tourType.destroy', ':id') }}";
                    $.ajax({
